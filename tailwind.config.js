  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        neutral: {
          background: customColors.neutral.background,
          surface: customColors.neutral.surface,
          border: customColors.neutral.border,
          textMain: customColors.neutral.textMain,
          textMuted: customColors.neutral.textMuted,
        },
        'dark-primary': {
          100: customColors.dark.primary.lighter,
          200: customColors.dark.primary.lighter,
          300: customColors.dark.primary.light,
          400: customColors.dark.primary.light,
          500: customColors.dark.primary.main,
          600: customColors.dark.primary.main,
          700: customColors.dark.primary.dark,
          800: customColors.dark.primary.dark,
          900: customColors.dark.primary.darker,
        },
        'dark-secondary': {
          100: customColors.dark.secondary.lighter,
          200: customColors.dark.secondary.lighter,
          300: customColors.dark.secondary.light,
          400: customColors.dark.secondary.light,
          500: customColors.dark.secondary.main,
          600: customColors.dark.secondary.main,
          700: customColors.dark.secondary.dark,
          800: customColors.dark.secondary.dark,
          900: customColors.dark.secondary.darker,
        },
        'dark-neutral': {
          background: customColors.dark.neutral.background,
          surface: customColors.dark.neutral.surface,
          border: customColors.dark.neutral.border,
          textMain: customColors.dark.neutral.textMain,
          textMuted: customColors.dark.neutral.textMuted,
        },
